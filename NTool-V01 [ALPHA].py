...
# en effet, une suppréssion calculer (plus lente) de fichier / dossier visé, on pointe notre supprésion sur ce qui joue vraiment dans le cache de FiveM
    ...
    shutil.rmtree("server-cache-priv", ignore_errors=True)
    if os.path.exists("server-cache-priv"):
        print("[FOLDER] - server-cache-priv ")
    else:
        print("[FOLDER] - server-cache-priv was not find")
  ...
  #CD Nui-Storage-Fxdk plusieur dossier cache 
    try:
        os.chdir("C:/Users/" + username+ "/AppData/Local/FiveM/FiveM.app/data/nui-storage")
    except:
        print("[Erreur N404] - data/nui-storage was not find")
...
def gestion_mods():
    ...
    print("\n               ╔══════════════════════════════╗")
    print("               ║                              ║")
    print("               ║       Gestion des mods :     ║")
    print("               ║                              ║")
    print("               ║   1. Activer tous les mods   ║")
    print("               ║                              ║")
    print("               ║  2. desactiver tous les mods ║")
    print("               ║                              ║")
    print("               ║     3. choix personnalisé    ║")
    print("               ║                              ║")
    print("               ╚══════════════════════════════╝\n")

    print("Liste des mods disponible : ")

    mods_folder = ["mods", "mods_NToolf"]
    try:
        path_mods = os.listdir("C:/Users/" + username+ "/AppData/Local/FiveM/FiveM.app/mods") 
        for mods in path_mods:
            print("- ", mods )  
    except:
        print("les mods sont désactiver dans votre installation.")
    ...
    choix = input('\nvotre choix : ')
    if choix == '1':
        os.rename("mods_NToolf", "mods")

    if choix == '2':
        os.rename("mods", "mods_NToolf")
